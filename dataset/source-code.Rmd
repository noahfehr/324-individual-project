...
```
TODO: Add plot with NoChina, add explanation of plot, Add variables to axes, add explanation to click on country option, add titles to graphs, change from greens to colors to have categorical not implied scale
```{r}
