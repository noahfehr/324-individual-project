...
```
TODO: add explanation of plots, add explanation to click on country option, add titles to graphs, change from greens to colors to have categorical not implied scale
```{r}
...
ui <- fluidPage(
  ...
  tabPanel("Consumption and Production",
      ...
      titlePanel(h6("After removing the outlier, China, we can focus on the remaining countries and the potential relationship amongst these countries")),
